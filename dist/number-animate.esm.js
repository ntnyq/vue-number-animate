...
function formatNumber (number, decimal, decimals, separator = ',', isRound) {
...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.bem('wrap')},[_c('div',{class:_vm.bem('inner')},[_vm._l((_vm.valueArr),function(item,index){return [(/^\d$/.test(item))?_c('div',{key:index,class:_vm.bem('num'),attrs:{"data-target":item}},_vm._l((_vm.numbers),function(str){return _c('span',{key:str,class:_vm.bem('span')},[_vm._v("\n          "+_vm._s(str)+"\n        ")])}),0):_c('div',{key:index,class:_vm.bem('symbol')},[_vm._v("\n        "+_vm._s(item)+"\n      ")])]})],2)])};
